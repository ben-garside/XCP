...
$GLOBALS['config']['sendItems']['global'] = array(
		...
		'systemUser'	=> -1,
		'recNote'		=> array("TO" => "Varun.Verma@bsigroup.com", "CC" => "ben.garside@bsigroup.com")
	);
...
$GLOBALS['config']['sendItems']['dev'] = array(
		...
		'ftp_user_name' => "xcp_uat_presend@hugatramp.com",
		'ftp_user_pass' => "9f4gp8quy0",
...
$GLOBALS['config']['sendItems']['prd'] = array(
		...
		// FTP settings
		'ftp_server' 	=> "ftp.hugatramp.com",
		'ftp_user_name' => "xcp_uat_final@hugatramp.com",
		'ftp_user_pass' => "yqasggery6",
