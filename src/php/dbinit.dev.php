...
$GLOBALS['config']['sendItems']['dev'] = array(
		...
		'recMain' => array(	"TO" => "ben.garside@bsigroup.com"),
		...
		'recPl8' => array(	"TO" => "ben.garside@bsigroup.com"),

		// FTP settings
		'ftp_server' 	=> "ftp.hugatramp.com",
		'ftp_user_name' => "xcp_dev_presend@hugatramp.com",
		'ftp_user_pass' => "2uyu0e7gyx",
...
$GLOBALS['config']['sendItems']['prd'] = array(
		...
		// FTP settings
		'ftp_server' 	=> "ftp.hugatramp.com",
		'ftp_user_name' => "xcp_dev_final@hugatramp.com",
		'ftp_user_pass' => "9ddnbtn3h0",
